...
- `/sdk`: Component libraries for web integration.
- `/extension`: Browser-side parsing and overlay logic.
- `/backend`: AI orchestration, narrative generation, and voice synthesis.
...
*Phase 1: Initializing the core architecture...*
